...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = r"C:\Users\shrey\Desktop\EduPersona\credentials.json"
project_id = "personalised-learning-system"
...
def preprocess_text(text):
    if text is None:
        raise ValueError("Input text is None, cannot preprocess.")
    ...
    if page == "PDF Upload":
        ...
        if st.session_state['pdf_text'] is None:
            ...
            if st.button("Generate Quiz", key="generate_quiz_button"):
                st.session_state['pdf_text'] = clean_text(st.session_state['pdf_text'])
